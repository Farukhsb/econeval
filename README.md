...
[![Version](https://img.shields.io/badge/version-v0.5.2-blue.svg)](https://github.com/Farukhsb/econeval/releases/tag/v0.5.2)
...
Latest release: [`v0.5.2`](https://github.com/Farukhsb/econeval/releases/tag/v0.5.2)
...
3. tag the release, for example `v0.5.2`
